...
- `architecture.md`: end-to-end flow, components, topics
...
- `upload.md`: multipart upload (retry + validation)
- `ci-cd.md`: GitHub Actions build/push images
- `runbook.md`: how to run + how to test quickly
